  ...
  platforms: [
    {
      ...
      columns: [
        ...
        { label: 'Score', key: 'competitiveBreakdown.leetcode.score', accessor: (row) => Math.round(row.competitiveBreakdown?.leetcode?.score || row.scores?.lcScore || 0), isScore: true }
      ]
    },
    {
      id: 'codechef',
      ...
      columns: [
        ...
        { label: 'Score', key: 'competitiveBreakdown.codechef.score', accessor: (row) => Math.round(row.competitiveBreakdown?.codechef?.score || row.scores?.ccScore || 0), isScore: true }
      ]
    },
    {
      id: 'geeksforgeeks',
      ...
      columns: [
        ...
        { label: 'Score', key: 'competitiveBreakdown.geeksforgeeks.score', accessor: (row) => Math.round(row.competitiveBreakdown?.geeksforgeeks?.score || row.scores?.gfgScore || 0), isScore: true }
      ]
    },
    {
      id: 'hackerrank',
      ...
      columns: [
        ...
        { label: 'Score', key: 'competitiveBreakdown.hackerrank.score', accessor: (row) => Math.round(row.competitiveBreakdown?.hackerrank?.score || row.scores?.hrScore || 0), isScore: true }
      ]
    }
  ]
};
