...
export function CoordinatorStudentsList() {
  ...
  const loadStudents = async () => {
    ...
    try {
      ...
      if (res.filters?.colleges) {
        setAvailableColleges(res.filters.colleges);
      }
  ...
  const totalPages = limit === 'all' || limit === 'All' ? 1 : Math.ceil(total / limit) || 1;
      ...
      <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        ...
        <div className="ct-card" style={{ padding: '1rem', display: 'flex', flexWrap: 'wrap', gap: '1rem', alignItems: 'center' }}>
          ...
          <select
            ...
            style={{ width: '140px', color: '#f3f4f6', background: '#111827' }}
          >
