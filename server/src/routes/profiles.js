  ...
  try {
    ...
    return res.json({
      profile: {
        ...
        goal: profileDoc?.goal || null,
        interestedDomain: profileDoc?.interestedDomain || null,
        collegeMentor: profileDoc?.collegeMentor || {},
        academicMentor: profileDoc?.academicMentor || {},
        codingMentor: profileDoc?.codingMentor || {},
        communicationMentor: profileDoc?.communicationMentor || {},
        projectMentor: profileDoc?.projectMentor || {},
        academicDetails: profileDoc?.academicDetails || {},
        ...
        profileCompletion: profileDoc?.profileCompletion || 0,
